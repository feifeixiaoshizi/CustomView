...
public class TouchSurfaceView extends SurfaceView implements SurfaceHolder.Callback, Runnable {

    private String TAG="TouchSurfaceView";
    ...
    public boolean onTouchEvent(MotionEvent event) {
        Log.d(TAG,"onTouchEvent的方法执行了"+event.getX()+" "+event.getY());
        float x= event.getX();
        float y = event.getY();
